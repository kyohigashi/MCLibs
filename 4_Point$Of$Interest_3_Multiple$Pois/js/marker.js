function Marker(poiData) {
    ...
    */
    ...
    this.markerHtmlDrawable = new AR.HtmlDrawable({
            html:"<body bgcolor='#E6E6FA'><h1>Hello world!</h1><p><a href='http://www.w3schools.com'>Visit W3Schools.com!</a></p></body>"
        },
        10,
        {
            zOrder: 0,
    ...
    this.markerObject = new AR.GeoObject(markerLocation, {
        drawables: {
            cam: [this.markerHtmlDrawable, this.markerDrawable_selected, this.titleLabel, this.descriptionLabel]
        }
    });
...
Marker.prototype.getOnClickTrigger = function(marker) {
    ...
    */
    ...
    return function() {
        ...
        document.location= 'architectsdk://' + JSON.stringify(marker);
        return true;
    };
};
